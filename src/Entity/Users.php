...
class Users implements UserInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Annonces::class, mappedBy="favories")
     */
    private $favories;
    ...
    public function addFavory(Annonces $favory): self
    {
    ...
    public function removeFavory(Annonces $favory): self
    {
